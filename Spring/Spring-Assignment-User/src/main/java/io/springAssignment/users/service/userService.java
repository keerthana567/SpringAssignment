...
public class userService {
    ...
    public List<UserEntity> getAllUser(Integer pageNo, Integer pageSize){
    ...
    public UserEntity addNewUser(UserEntity newUserData){
       return userRepo.save(newUserData);
    }

    public UserEntity updateUser(long id, UserEntity userData){
        Optional<UserEntity> DBData =  userRepo.findById(id);
        if (DBData.isPresent()) {
            UserEntity _dbData = DBData.get();
